...
<cfquery datasource="WCSTracking" name="textbookInfo_Query">
    ...
    <cfoutput>
        ...
        <div class="advSearch">
            <cfform action="AddTextbookAction.cfm">

                <input type="hidden" name="CourseID" value="#URL.CourseID#">

                <label>ISBN: </label>
                <input type="text"
                        name="ISBN_TextBoxADD"
                        required
                        pattern="[0-9]{13}"
                        title="13 digits"
                        maxlength="13"
                ...
                <label>Edition: </label>
                <input type="text"
                       name="edition_TextBoxADD"
                       maxlength="2"
                       autocomplete="off">

                <label>Author: </label>
                <input type="text"
                       name="author_TextBoxADD"
                       size="30"
                       maxlength="50"
                       autocomplete="off">
    ...
    <label> </label>
        ...
        <cfform action="AddTextbookAction2.cfm">
            ...
            <div class="container results-Table">
                <table>
                    ...
                    <cfoutput query="textbookInfo_Query">
                        <tr class="lowercase">
                            <td><input type="radio" name="ExistingTextbookISBN_RadioBoxADD" value="#TextbookInfo_Query.ISBN#"></td>
